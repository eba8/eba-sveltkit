...
<footer class="bg-white mt-1">
    <div class="px-4 mx-auto overflow-hidden max-w-7xl sm:px-6 lg:px-8">
      ...
      <div class="flex justify-center mt-8 space-x-6">  
        ...
        <a href="https://github.com/eba8" class="text-gray-400 hover:text-gray-500">
        ...
        <a sveltekit:prefetch href="/subscribe" class="text-gray-400 hover:text-gray-500" class:active={$page.path === '/subscribe'}>
