<div class="flex flex-col items-center justify-center">
	<div class="flex flex-col justify-center sm:px-6 lg:px-8">
		<div class="sm:mx-auto sm:w-full sm:max-w-md">
			<h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Follow along! :)</h2>
		...
		<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
			<div class="bg-white px-4 sm:rounded-lg sm:px-10">
				<form
					class="space-y-6"
					action="https://www.getrevue.co/profile/edanbenatar/add_subscriber"
					method="post"
				>
					<div>
						<div class="mt-1">
							<input
								...
								required
								class="revue-form-field appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
							/>
						</div>
					</div>
			...
			<div class="mt-5 px-5 text-center text-gray-600">
